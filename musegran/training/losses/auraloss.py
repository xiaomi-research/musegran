# Copyright (c) 2020 Christian J. Steinmetz
# SPDX-License-Identifier: Apache-2.0
# Adapted from https://github.com/csteinmetz1/auraloss/blob/main/auraloss/freq.py
        ...
        **kwargs
        ...
        if scale is not None:
            try:
                ...
                raise ImportError("librosa is required for mel/chroma scale. Try `pip install auraloss[all]`.") from e
